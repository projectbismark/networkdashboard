...
#feedback.html?device=231425325
    ...
    # site URLs
     ...
     (r'^display_device/(?P<devicehash>\w+)', 'networkdashboard.summary.views.shared_device_summary'),
     (r'^edit_device_page/(?P<devicehash>\w+)', 'networkdashboard.summary.views.edit_device_page'),
     (r'^get_location/(?P<device>\w+)', 'networkdashboard.summary.views.get_location'),
