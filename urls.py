...
urlpatterns = patterns('',
    ...
    # site URLs
     ...
     (r'^displayDevice/(?P<devicename>\w+)', 'networkdashboard.summary.views.sharedDeviceSummary'),
     (r'^editDevicePage/(?P<devicename>\w+)', 'networkdashboard.summary.views.editDevicePage'),
