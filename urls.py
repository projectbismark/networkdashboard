...
#feedback.html?device=231425325
    ...
    # site URLs
	 ...
	 (r'^compare_by_isp/(?P<isp>.+)', 'networkdashboard.summary.views.compare_by_isp'),
	 ...
	 (r'^compare_bitrate_by_isp/', 'networkdashboard.summary.views.compare_bitrate_by_isp'),
	 ...
	 (r'^compare_lmrtt_by_isp/', 'networkdashboard.summary.views.compare_lmrtt_by_isp'),
	 ...
	 (r'^compare_rtt_by_isp/', 'networkdashboard.summary.views.compare_rtt_by_isp'),
